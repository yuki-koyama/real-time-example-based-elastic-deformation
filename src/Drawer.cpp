...
void Drawer::draw()
{
    ...
    gluLookAt(
        lightPos[0], lightPos[1], lightPos[2], f.x_ + offset.x_, f.y_ + offset.y_, f.z_ + offset.z_, u.x_, u.y_, u.z_);
    ...
    glDisable(GL_LIGHTING);
    glBegin(GL_QUADS);
    glColor3(core.m_config.BGCOLOR_BOTTOM);
    glVertex2d(0, 0);
    glVertex2d(w, 0);
    glColor3(core.m_config.BGCOLOR_TOP);
    glVertex2d(w, h);
    glVertex2d(0, h);
    glEnd();
    glDepthMask(GL_TRUE);
...
Drawer::Drawer() : m_fovy(40), m_nearClip(0.1), m_farClip(100000) {}
